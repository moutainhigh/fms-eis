 ...
 * Author :
 * Date :
 * Title : org.fms.eis.webapp.vo.EMpXlMonVO.java
 **/
...
public class EMpXlMonVO extends ManagerParamVO {
    ...
    public EMpXlMonDomain vo2Domain() {
        EMpXlMonDomain eMpXlMonDomain = ReflectUtil.cast(this, EMpXlMonDomain.class);
        return eMpXlMonDomain;
    }
}
