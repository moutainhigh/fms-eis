...
public class RCpVO extends ManagerParamVO {
	...
	public RCpDomain vo2Domain() {
		RCpDomain _Domain = new RCpDomain();
				_Domain.setId(this.id);
				_Domain.setCode(this.code);
				_Domain.setName(this.name);
				_Domain.setCpTypeCode(this.cpTypeCode);
				_Domain.setStatusCode(this.statusCode);
				_Domain.setCpAddr(this.cpAddr);
				_Domain.setGpsLongitude(this.gpsLongitude);
				_Domain.setGpsLatitude(this.gpsLatitude);
				_Domain.setBusinessPlaceCode(this.businessPlaceCode);
				_Domain.setTplId(this.tplId);
				_Domain.setTerminalId(this.terminalId);
				_Domain.setRelaObjType(this.relaObjType);
				_Domain.setRelaObjId(this.relaObjId);
				_Domain.setCFlag(this.cFlag);
				_Domain.setTerminalAddr(this.terminalAddr);
				_Domain.setProtocolId(this.protocolId);
				_Domain.setCtrlHostid(this.ctrlHostid);
				_Domain.setMasterChnlGroup(this.masterChnlGroup);
				_Domain.setMasterIpPort(this.masterIpPort);
				_Domain.setMasterTel(this.masterTel);
				_Domain.setSpareChnlGroup(this.spareChnlGroup);
				_Domain.setSpareIpPort(this.spareIpPort);
				_Domain.setSpareTel(this.spareTel);
				_Domain.setGprsCode(this.gprsCode);
				_Domain.setHeartbeatCycle(this.heartbeatCycle);
				_Domain.setAlgNo(this.algNo);
				_Domain.setAlgKey(this.algKey);
				_Domain.setAreaCode(this.areaCode);
				_Domain.setMasterid(this.masterid);
				_Domain.setGuid(this.guid);
