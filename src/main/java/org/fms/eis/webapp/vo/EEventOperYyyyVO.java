 ...
 * Author :
 * Date :
 * Title : org.fms.eis.webapp.vo.EEventOperYyyyVO.java
 **/
...
public class EEventOperYyyyVO extends ManagerParamVO {
    ...
    public EEventOperYyyyDomain vo2Domain() {
        EEventOperYyyyDomain eEventOperYyyyDomain = ReflectUtil.cast(this, EEventOperYyyyDomain.class);
        return eEventOperYyyyDomain;
    }
}
