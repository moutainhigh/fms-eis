 ...
 * Author :
 * Date :
 * Title : org.fms.eis.webapp.vo.EEngyVerifyVO.java
 **/
...
public class EEngyVerifyVO extends ManagerParamVO {
    ...
    public EEngyVerifyDomain vo2Domain() {
        EEngyVerifyDomain eEngyVerifyDomain = ReflectUtil.cast(this, EEngyVerifyDomain.class);
        return eEngyVerifyDomain;
    }
}
