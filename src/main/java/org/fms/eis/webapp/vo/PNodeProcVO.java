 ...
 * Author :
 * Date :
 * Title : org.fms.eis.webapp.vo.PNodeProcVO.java
 **/
...
public class PNodeProcVO extends ManagerParamVO {
    ...
    public PNodeProcDomain vo2Domain() {
        PNodeProcDomain pNodeProcDomain = ReflectUtil.cast(this, PNodeProcDomain.class);
        return pNodeProcDomain;
    }
}
