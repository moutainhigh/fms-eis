 ...
 * Author :
 * Date :
 * Title : org.fms.eis.webapp.vo.EMpBmMonVO.java
 **/
...
public class EMpBmMonVO extends ManagerParamVO {
    ...
    public EMpBmMonDomain vo2Domain() {
        EMpBmMonDomain eMpBmMonDomain = ReflectUtil.cast(this, EMpBmMonDomain.class);
        return eMpBmMonDomain;
    }
}
