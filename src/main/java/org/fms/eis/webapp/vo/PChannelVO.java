...
public class PChannelVO extends ManagerParamVO {
	...
	public PChannelDomain vo2Domain() {
		PChannelDomain _Domain = new PChannelDomain();
				_Domain.setId(this.id);
				_Domain.setCode(this.code);
				_Domain.setName(this.name);
				_Domain.setChnlGroupId(this.chnlGroupId);
				_Domain.setDeviceAddr1(this.deviceAddr1);
				_Domain.setDeviceAddr2(this.deviceAddr2);
				_Domain.setCtrlhostId(this.ctrlhostId);
				_Domain.setBaud(this.baud);
				_Domain.setDatabit(this.databit);
				_Domain.setStopbit(this.stopbit);
				_Domain.setCheckbit(this.checkbit);
				_Domain.setInitstr(this.initstr);
				_Domain.setProtocolId(this.protocolId);
				_Domain.setNormalopen(this.normalopen);
