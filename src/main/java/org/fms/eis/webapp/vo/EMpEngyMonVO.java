 ...
 * Author :
 * Date :
 * Title : org.fms.eis.webapp.vo.EMpEngyMonVO.java
 **/
...
public class EMpEngyMonVO extends ManagerParamVO {
    ...
    public EMpEngyMonDomain vo2Domain() {
        EMpEngyMonDomain eMpEngyMonDomain = ReflectUtil.cast(this, EMpEngyMonDomain.class);
        return eMpEngyMonDomain;
    }
}
