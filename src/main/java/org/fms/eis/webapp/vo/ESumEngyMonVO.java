 ...
 * Author :
 * Date :
 * Title : org.fms.eis.webapp.vo.ESumEngyMonVO.java
 **/
...
public class ESumEngyMonVO extends ManagerParamVO {
    ...
    public ESumEngyMonDomain vo2Domain() {
        ESumEngyMonDomain eSumEngyMonDomain = ReflectUtil.cast(this, ESumEngyMonDomain.class);
        return eSumEngyMonDomain;
    }
}
