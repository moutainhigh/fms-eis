 ...
 * Author :
 * Date :
 * Title : org.fms.eis.webapp.vo.EEventCheckVO.java
 **/
...
public class EEventCheckVO extends ManagerParamVO {

    private BigDecimal eventNo;    //事件编码
    private String objId;    //对象编码
    private String objType;    //对象类型
    private String eventAlarmLevel;    //对象告警级别 标准编码：1.131告警级别【EVENT_GRADE】0---由事件编码决定 99—不告警  其他—由该字段决定
    ...
    public EEventCheckDomain vo2Domain() {
        EEventCheckDomain eEventCheckDomain = ReflectUtil.cast(this, EEventCheckDomain.class);
        return eEventCheckDomain;
    }
}
