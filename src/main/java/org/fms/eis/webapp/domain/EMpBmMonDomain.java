 ...
 * Author :
 * Date :
 * Title : org.fms.eis.webapp.domain.EMpBmMonDomain.java
 **/
...
public class EMpBmMonDomain extends Page implements MybatisEntity {
    @TablePrimaryKey
    ...
    public EMpBmMonVO domain2VO() {
        EMpBmMonVO eMpBmMonVO = ReflectUtil.cast(this, EMpBmMonVO.class);
        return eMpBmMonVO;
    }
