 ...
 * Author :
 * Date :
 * Title : org.fms.eis.webapp.domain.EMpEngyMonDomain.java
 **/
...
public class EMpEngyMonDomain extends Page implements MybatisEntity {
    @TablePrimaryKey
    ...
    public EMpEngyMonVO domain2VO() {
        EMpEngyMonVO eMpEngyMonVO = ReflectUtil.cast(this, EMpEngyMonVO.class);
        return eMpEngyMonVO;
    }
