 ...
 * Author :
 * Date :
 * Title : org.fms.eis.webapp.domain.EBmRollbackDomain.java
 **/
...
public class EBmRollbackDomain extends Page implements MybatisEntity {
    @TablePrimaryKey
    private Long mpedId;    //测量点标识
    private Date dataTime;    //数据时间
    private String datasaveType;    //数据属性 01-曲线02-日冻结03-月冻结
    ...
    private BigDecimal p6r0;    //三象限无功总
    private BigDecimal p6r0P;    //质量码
    private BigDecimal p7r0;    //二象限无功总
    ...
    private BigDecimal p6r1;    //三象限无功尖
    private BigDecimal p7r1;    //二象限无功尖
    ...
    private BigDecimal p6r2;    //三象限无功峰
    private BigDecimal p7r2;    //二象限无功峰
    ...
    private BigDecimal p6r3;    //三象限无功平
    private BigDecimal p7r3;    //二象限无功平
    ...
    private BigDecimal p6r4;    //三象限无功谷
    private BigDecimal p7r4;    //二象限无功谷
    ...
    private BigDecimal p6r5;    //三象限无功脊谷
    private BigDecimal p7r5;    //二象限无功脊谷
    private BigDecimal p8r5;    //四象限无功脊谷
    private BigDecimal apCoef;    //有功电量系数
    private BigDecimal rpCoef;    //无功电量系数
    ...
    public EBmRollbackVO domain2VO() {
        EBmRollbackVO eBmRollbackVO = ReflectUtil.cast(this, EBmRollbackVO.class);
        return eBmRollbackVO;
    }
