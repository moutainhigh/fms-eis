 ...
 * Author : 
 * Date : 
 * Title : org.fms.eis.webapp.domain.PMpedDomain.java
 *
**/
...
public class PMpedDomain extends Page implements MybatisEntity {
	@TablePrimaryKey
	...
	public PMpedVO domain2VO() {
        PMpedVO pMpedVO = ReflectUtil.cast(this,PMpedVO.class);
        return pMpedVO;
	}
