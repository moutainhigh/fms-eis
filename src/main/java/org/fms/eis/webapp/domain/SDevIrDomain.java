 ...
 * Author :
 * Date :
 * Title : org.fms.eis.webapp.domain.SDevIrDomain.java
 **/
...
public class SDevIrDomain extends Page implements MybatisEntity {
    @TablePrimaryKey
    private Long id;    //装拆记录标识
    private Long cpId;    //采集点标识
    private Long mpedId;    //测量点标识
    private String equipTypeCode;    //设备类别
    private Long equipId;    //设备标识
    ...
    public SDevIrVO domain2VO() {
        SDevIrVO sDevIrVO = ReflectUtil.cast(this, SDevIrVO.class);
        return sDevIrVO;
    }
