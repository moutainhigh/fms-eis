 ...
 * Author :
 * Date :
 * Title : org.fms.eis.webapp.domain.ESumEngyDayDomain.java
 **/
...
public class ESumEngyDayDomain extends Page implements MybatisEntity {
    @TablePrimaryKey
    ...
    public ESumEngyDayVO domain2VO() {
        ESumEngyDayVO eSumEngyDayVO = ReflectUtil.cast(this, ESumEngyDayVO.class);
        return eSumEngyDayVO;
    }
