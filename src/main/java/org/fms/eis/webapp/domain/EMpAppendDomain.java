 ...
 * Author :
 * Date :
 * Title : org.fms.eis.webapp.domain.EMpAppendDomain.java
 **/
...
public class EMpAppendDomain extends Page implements MybatisEntity {
    @TablePrimaryKey
    ...
    public EMpAppendVO domain2VO() {
        EMpAppendVO eMpAppendVO = ReflectUtil.cast(this, EMpAppendVO.class);
        return eMpAppendVO;
    }
