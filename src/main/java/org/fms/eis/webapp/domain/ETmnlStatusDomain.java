 ...
 * Author :
 * Date :
 * Title : org.fms.eis.webapp.domain.ETmnlStatusDomain.java
 **/
...
public class ETmnlStatusDomain extends Page implements MybatisEntity {
    @TablePrimaryKey
    ...
    public ETmnlStatusVO domain2VO() {
        ETmnlStatusVO eTmnlStatusVO = ReflectUtil.cast(this, ETmnlStatusVO.class);
        return eTmnlStatusVO;
    }
