 ...
 * Author :
 * Date :
 * Title : org.fms.eis.webapp.domain.ENodeInfoDomain.java
 **/
...
public class ENodeInfoDomain extends Page implements MybatisEntity {
    @TablePrimaryKey
    ...
    public ENodeInfoVO domain2VO() {
        ENodeInfoVO eNodeInfoVO = ReflectUtil.cast(this, ENodeInfoVO.class);
        return eNodeInfoVO;
    }
