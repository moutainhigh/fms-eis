 ...
 * Author :
 * Date :
 * Title : org.fms.eis.webapp.domain.ESumEngyMonDomain.java
 **/
...
public class ESumEngyMonDomain extends Page implements MybatisEntity {
    @TablePrimaryKey
    ...
    public ESumEngyMonVO domain2VO() {
        ESumEngyMonVO eSumEngyMonVO = ReflectUtil.cast(this, ESumEngyMonVO.class);
        return eSumEngyMonVO;
    }
