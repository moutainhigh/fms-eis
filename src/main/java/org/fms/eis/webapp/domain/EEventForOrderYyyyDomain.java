 ...
 * Author :
 * Date :
 * Title : org.fms.eis.webapp.domain.EEventForOrderYyyyDomain.java
 **/
...
public class EEventForOrderYyyyDomain extends Page implements MybatisEntity {
    @TablePrimaryKey
    ...
    public EEventForOrderYyyyVO domain2VO() {
        EEventForOrderYyyyVO eEventForOrderYyyyVO = ReflectUtil.cast(this, EEventForOrderYyyyVO.class);
        return eEventForOrderYyyyVO;
    }
