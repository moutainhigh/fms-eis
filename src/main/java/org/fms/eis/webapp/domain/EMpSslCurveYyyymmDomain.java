 ...
 * Author :
 * Date :
 * Title : org.fms.eis.webapp.domain.EMpSslCurveYyyymmDomain.java
 **/
...
public class EMpSslCurveYyyymmDomain extends Page implements MybatisEntity {
    @TablePrimaryKey
    ...
    public EMpSslCurveYyyymmVO domain2VO() {
        EMpSslCurveYyyymmVO eMpSslCurveYyyymmVO = ReflectUtil.cast(this, EMpSslCurveYyyymmVO.class);
        return eMpSslCurveYyyymmVO;
    }
