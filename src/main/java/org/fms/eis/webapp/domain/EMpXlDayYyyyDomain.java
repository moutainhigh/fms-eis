 ...
 * Author :
 * Date :
 * Title : org.fms.eis.webapp.domain.EMpXlDayYyyyDomain.java
 **/
...
public class EMpXlDayYyyyDomain extends Page implements MybatisEntity {
    @TablePrimaryKey
    ...
    public EMpXlDayYyyyVO domain2VO() {
        EMpXlDayYyyyVO eMpXlDayYyyyVO = ReflectUtil.cast(this, EMpXlDayYyyyVO.class);
        return eMpXlDayYyyyVO;
    }
