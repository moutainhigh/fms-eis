 ...
 * Author :
 * Date :
 * Title : org.fms.eis.webapp.domain.EMpBmDayYyyyDomain.java
 **/
...
public class EMpBmDayYyyyDomain extends Page implements MybatisEntity {
    @TablePrimaryKey
    ...
    public EMpBmDayYyyyVO domain2VO() {
        EMpBmDayYyyyVO eMpBmDayYyyyVO = ReflectUtil.cast(this, EMpBmDayYyyyVO.class);
        return eMpBmDayYyyyVO;
    }
