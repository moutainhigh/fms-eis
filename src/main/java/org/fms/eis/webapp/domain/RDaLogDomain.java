 ...
 * Author :
 * Date :
 * Title : org.fms.eis.webapp.domain.RDaLogDomain.java
 **/
...
public class RDaLogDomain extends Page implements MybatisEntity {
    @TablePrimaryKey
    ...
    public RDaLogVO domain2VO() {
        RDaLogVO rDaLogVO = ReflectUtil.cast(this, RDaLogVO.class);
        return rDaLogVO;
    }
