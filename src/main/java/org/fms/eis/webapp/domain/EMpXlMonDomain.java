 ...
 * Author :
 * Date :
 * Title : org.fms.eis.webapp.domain.EMpXlMonDomain.java
 **/
...
public class EMpXlMonDomain extends Page implements MybatisEntity {
    @TablePrimaryKey
    ...
    public EMpXlMonVO domain2VO() {
        EMpXlMonVO eMpXlMonVO = ReflectUtil.cast(this, EMpXlMonVO.class);
        return eMpXlMonVO;
    }
